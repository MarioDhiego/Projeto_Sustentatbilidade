...
ui <- dashboardPage(
  ...
  dashboardSidebar(
    ...
    sidebarMenu(
      ...
      menuItem("PERCEPÇÃO",
        tabName = "escalalikert", icon = icon("book"),
      ...
      selectInput("cnh", "POSSUI CNH:",
        choices = c(unique(data$CNH)),
        selected = unique(data$MUNICIPIO)[1]
      ),
      selectInput("destino", "DESTINO LIXO:",
        choices = c(unique(data$P21)),
        selected = unique(data$P21)[1]
      ),
...
Fiscalização em nível Estadual."
      ...
      tabItem(
        ...
        fluidRow(
          ...
          box(
            title = "Distribuição por Grau de Escolaridade",
            status = "success",
            solidHeader = TRUE,
            collapsible = TRUE,
          ...
          box(
            title = "Distribuição por Cargo/Função",
            status = "success",
            solidHeader = TRUE,
            collapsible = TRUE,
      ...
      tabItem(
        ...
        fluidRow(
          box(
            title = "NO SEU BAIRRO TÊM COLETA SELETIVA?",
            status = "success",
            solidHeader = TRUE,
            collapsible = TRUE,
          ...
          box(
            title = "RECEBEU INFORMES SOBRE COLETA SELETIVA?",
            status = "success",
            solidHeader = TRUE,
            collapsible = TRUE,
          ...
          box(
            title = "SABE SEPARAR CORRETAMENTE O LIXO?",
            status = "success",
            solidHeader = TRUE,
            collapsible = TRUE,
      ...
      tabItem(
        ...
        fluidRow(
          box(
            title = "Facilidade de Encontrar Lixeiras",
            status = "success",
            solidHeader = TRUE,
            collapsible = TRUE,
          ...
          box(
            title = "Sabe o Destino Final do Lixo Ciretran",
            status = "success",
            solidHeader = TRUE,
            collapsible = TRUE,
...
",
  ...
  data <- readxl::read_excel("BANCO_PROJETO_SUSTENTABILIDADE.xls")
